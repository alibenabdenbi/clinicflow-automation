# Client Setup Guide — Yonge Dental Care
...
3. Rename the automation: **"Missed Call Recovery — Yonge Dental Care"**
...
2. Name: **"Appointment Reminders — Yonge Dental Care"**
...
2. Name: **"New Patient Welcome — Yonge Dental Care"**
...
1. **Automations** → **Create** → **Classic Automation** → **Date-based**
2. Name: **"Review Request — Yonge Dental Care"**
