# Appointment Reminder Templates — Yonge Dental Care

---

## 72-Hour SMS Reminder

Hi [PatientFirstName], this is Yonge Dental Care. Your appointment is on [AppointmentDate] at [AppointmentTime]. Reply YES to confirm or call [ClinicPhone] if you need to reschedule. See you soon!
...
Hi [PatientFirstName], see you tomorrow at [AppointmentTime] at Yonge Dental Care! If anything comes up, call [ClinicPhone] and we'll find another time. Looking forward to it.

---

## Day-Of Reminder (Optional — send 2 hours before)

Hi [PatientFirstName], your appointment at Yonge Dental Care is in about 2 hours ([AppointmentTime]). See you soon!
