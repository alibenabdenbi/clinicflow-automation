# Client Setup Guide — Christie Park Dental
...
3. Rename the automation: **"Missed Call Recovery — Christie Park Dental"**
...
2. Name: **"Appointment Reminders — Christie Park Dental"**
...
2. Name: **"New Patient Welcome — Christie Park Dental"**
...
1. **Automations** → **Create** → **Classic Automation** → **Date-based**
2. Name: **"Review Request — Christie Park Dental"**
