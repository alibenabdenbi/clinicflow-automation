# New Patient Welcome Sequence — Christie Park Dental
...
**Subject:** You're booked at Christie Park Dental

Hi [PatientFirstName],

Welcome — we're glad you chose Christie Park Dental.
...
Your appointment at Christie Park Dental is tomorrow at [AppointmentTime]. A few things that make first visits smoother:
...
Thanks again for choosing Christie Park Dental.

The Christie Park Dental Team

---

**Note:** The [ReviewLink] should be your Google Business Profile review URL. Get it by searching "Christie Park Dental Toronto" on Google Maps, clicking your listing, then clicking "Write a review" and copying the URL. Test it yourself first.