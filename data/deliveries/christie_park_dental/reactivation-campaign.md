# Patient Reactivation Campaign — Christie Park Dental
...
We noticed it's been some time since we've seen you at Christie Park Dental, and we wanted to check in.
...
**Subject:** What's new at Christie Park Dental
...
If you'd like to keep your preferred time at Christie Park Dental, now's a good moment to book. [BookingLink] or [ClinicPhone].
...
If you ever want to come back to Christie Park Dental, we'll be here. No awkward re-introductions needed — just book at [BookingLink] and we'll pick up where we left off.
...
**How to launch a batch:** Export patients from your PMS (filter: last visit > 12 months ago). Send the list to contact@clinicflowautomation.com with the subject "Reactivation batch — Christie Park Dental". We'll confirm receipt and launch within 24 hours.