# Appointment Reminder Templates — Bayview Village Dental

---

## 72-Hour SMS Reminder

Hi [PatientFirstName], this is Bayview Village Dental. Your appointment is on [AppointmentDate] at [AppointmentTime]. Reply YES to confirm or call [ClinicPhone] if you need to reschedule. See you soon!
...
Hi [PatientFirstName], see you tomorrow at [AppointmentTime] at Bayview Village Dental! If anything comes up, call [ClinicPhone] and we'll find another time. Looking forward to it.

---

## Day-Of Reminder (Optional — send 2 hours before)

Hi [PatientFirstName], your appointment at Bayview Village Dental is in about 2 hours ([AppointmentTime]). See you soon!
